  ...
  connect() {
    console.log("hello");
      ...
      function stackedCards () {
        ...
        stackedCardsObj = document.querySelector('.stackedcards-container');
        listElNodesObj = stackedCardsObj.children;

        topObj = document.querySelector('.stackedcards-overlay.top');
        rightObj = document.querySelector('.stackedcards-overlay.right');
        leftObj = document.querySelector('.stackedcards-overlay.left');
